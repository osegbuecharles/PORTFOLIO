...
async function shareBlog(i,subject,author){
    ...
    $(".modal-body").html(`
        <div>
            <a onclick="share(`+i+`)" target="_blank" href="https://api.whatsapp.com/send?text=`+subject+`&nbsp;by&nbsp;`+author+`%20%0A%0a%20`+shareurl+`?id=`+i+`"><i style="font-size: 40px;margin:0 10px;" class="fa fa-whatsapp text-success"></i></a>
            <a onclick="share(`+i+`)" target="_blank" href="https://twitter.com/intent/tweet?text=`+subject+`&nbsp;by&nbsp;`+author+`&url=`+shareurl+`%2F?id=`+i+`%2F&via=AUIAA"><i style="font-size: 40px;margin:0 10px;" class="fa fa-twitter text-primary"></i></a>
            <a onclick="share(`+i+`)" target="_blank" href="https://web.facebook.com/sharer/sharer.php?u=`+shareurl+`?id=`+i+`"><i style="font-size: 40px;margin:0 10px;" class="fa fa-facebook text-primary"></i></a>
        </div>
...
async function loadBlog(pageNum){
    ...
    $("#blogView").html(`<div style="text-align: center;"><img src="${preloader}" style="width:10%"></div>`);
    $("#paginationBlog").html(``);
                ...
                for(i=0;i<data.data.length;i++){ 
                        ...
                        <article class="entry" data-aos="fade-up">
                          ...
                          <div class="entry-meta">
                            <ul>                              
                              <li class="d-flex align-items-center" style="cursor:pointer" onclick="loadCategory('author','`+data.data[i].author+`')"><i class="fa fa-user"></i> <a>`+data.data[i].author+`</a></li>
                              <li class="d-flex align-items-center" style="cursor:pointer" onclick="loadCategory('date','`+data.data[i].dateCreated+`')"><i class="fa fa-clock"></i> <a><time datetime="`+data.data[i].dateCreated+`">`+data.data[i].dateCreated+`</time></a></li>                    
                              <li class="d-flex align-items-center"><i class="fa fa-eye" ></i> <a id="view`+data.data[i].id+`"></a></li>
                              <li class="d-flex align-items-center"><i class="fa fa-comment" ></i> <a id="comment`+data.data[i].id+`"></a></li>                                      
                              ...
                              <li class="d-flex align-items-center shareBlog" onclick="shareBlog(`+data.data[i].id+`,'`+data.data[i].subject+`','`+data.data[i].author+`')" style="cursor: pointer;"><i class="fa fa-share" ></i> <a id="share`+data.data[i].id+`"></a></li>                                                            
                            </ul>
                          </div>
                ...
                <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                        ...
                        <li id="prevPgBlog" class="page-item disabled">
                            <a class="page-link bg-dark border-warning" tabindex="-1">Previous</a>
                        </li>
                ...
                <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item disabled">
                            <a class="page-link bg-dark border-warning" tabindex="-1">Next</a>
                        </li>
            ...
            if(j==pageNum){
                $("#prevPgBlog").after(`
                    <li class="page-item active">
                        <a class="page-link bg-warning text-dark border-warning">`+j+`<span class="sr-only">(current)</span></a>
                    </li>
                `);
            }
            else{
    ...
    if(dataCa.length>0){
        ...
        for(ca=0;ca<dataCa.data.length;ca++){
            ...
            <article class="entry" data-aos="fade-up">
              ...
              <div class="entry-meta">
                <ul>
                <li class="d-flex align-items-center" style="cursor:pointer" onclick="loadCategory('author','`+dataCa.data[ca].author+`')"><i class="fa fa-user"></i> <a>`+dataCa.data[ca].author+`</a></li>
                <li class="d-flex align-items-center" style="cursor:pointer" onclick="loadCategory('date','`+dataCa.data[ca].dateCreated+`')"><i class="fa fa-clock"></i> <a><time datetime="`+dataCa.data[ca].dateCreated+`">`+dataCa.data[ca].dateCreated+`</time></a></li>
                <li class="d-flex align-items-center"><i class="fa fa-eye"></i> <a id="viewCa`+dataCa.data[ca].id+`"></a></li>
                <li class="d-flex align-items-center"><i class="fa fa-comment"></i> <a id="commentCa`+dataCa.data[ca].id+`"></a></li>
                <li class="d-flex align-items-center"><i id="likeIconCa`+dataCa.data[ca].id+`" onclick="likeBlog1(`+dataCa.data[ca].id+`,'`+criteria+`','`+value+`')" style="cursor: pointer; font-size:x-large;" class="fa fa-heart likeIcon"></i><a id="likeCa`+dataCa.data[ca].id+`"></a></li>
                <li class="d-flex align-items-center shareBlog" onclick="shareBlog1(`+dataCa.data[ca].id+`,'`+dataCa.data[ca].subject+`','`+dataCa.data[ca].author+`','`+criteria+`','`+value+`')" style="cursor: pointer;"><i class="fa fa-share"></i> <a id="shareCa`+dataCa.data[ca].id+`"></a></li>
                </ul>
              </div>
...
async function loadBlogInfo1(criteria,value){
    ...
    for(k=0;k<data.data.length;k++){    
        ...
        if(liked!=null){    
            ...
            if(liked[ek]=="true"){
                $("#likeIconCa"+ek).css({"color":"red","cursor":"default"});
...
async function searchBlog(value){
    ...
    $("#listingView").html(`<div style="text-align: center;"><img src="${preloader}" style="width:10%"></div>`);
